...
export const createFamilyMemberSchema = z.object({
  ...
  specificRelationship: z.enum([
    'father', 'mother',
    'paternal_grandfather', 'paternal_grandmother',
    'maternal_grandfather', 'maternal_grandmother',
    'brother', 'sister',
    'paternal_uncle', 'paternal_aunt',
    'paternal_uncle_wife', 'paternal_aunt_husband',
    'maternal_uncle', 'maternal_aunt',
    'maternal_uncle_wife', 'maternal_aunt_husband',
    'cousin',
    'step_parent', 'step_sibling',
    'other',
  ]).optional(),
  side: z.enum(['paternal', 'maternal', 'direct']).default('direct'),
